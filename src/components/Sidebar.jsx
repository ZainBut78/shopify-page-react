      ...
      <div className="space-y-0.5 flex-1">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-3 px-3 py-1.5 bg-white shadow-sm rounded-lg cursor-pointer">
            ...
            <span className="text-sm font-bold text-[#303030]">Vidify</span>
          </div>
          <div className="pl-11 py-1 text-[#616161] space-y-2">
            {/* ✅ Link sahi import ke baad kaam karega */}
            <Link to="/GenrateVedio" className="block text-sm hover:text-black cursor-pointer">
              Generate Video
            </Link>
            <Link to='/SubscriptionPlan' className="text-sm hover:text-black cursor-pointer">Subscription Plan</Link>
          </div>
        </div>
      </div>
    </aside>
